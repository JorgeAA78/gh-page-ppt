...
function initRouter(container) {
    ...
    if (location.pathname === "/" || location.pathname.endsWith('/gh-page-ppt/')) goTo("/welcome");
    else handleRoute(processPath(location.pathname));
...
},{"../pages/welcome":"5MH9k","../pages/instructions":"cwpNh","../pages/play":"HxBRi","../pages/result":"drinv","../pages/showdown":"96tSt","../state/state":"gsPiT","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"5MH9k":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function initPlayPage(params) {
    ...
    const updateCountdown = ()=>{
        ...
        if (countdown < 0) {
            ...
            if ((0, _state.state).getState().currentGame.playerPlay === "") (0, _state.state).setPlayerMove(""); // Esto hará que la computadora elija una jugada
...
const lluviaGif = require("82395af4d024a47a");
const winSound = require("732e4cc667e81c39"); // Placeholder, please provide the correct filename
function initResultPage(params) {
    ...
    if (playerWins) {
        ...
        finalResult = true;
        resultText = "\xa1Ganaste la partida!";
        ...
        const roundResult = (0, _state.state).whoWins(currentState.currentGame.playerPlay, currentState.currentGame.computerPlay);
        if (roundResult === 'win') {
            resultImg = ganasteImg;
  ...
  `;
    ...
    if (playAgainButton) playAgainButton.addEventListener('click', ()=>{
        if (finalResult) (0, _state.state).resetHistory();
        params.goTo('/play');
    });
    return div;
}

},{"../state/state":"gsPiT","2e403ff75047d0eb":"7lZtU","fe1c75640e8e5b1":"DqBVQ","82395af4d024a47a":"hl4xa","732e4cc667e81c39":"g4beU","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"7lZtU":[function(require,module,exports,__globalThis) {
...
},{}],"hl4xa":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("lluvia.e783db11.gif") + "?" + Date.now();

},{}],"g4beU":[function(require,module,exports,__globalThis) {
module.exports = module.bundle.resolve("ganaste.f1c0f0b9.mp3") + "?" + Date.now();
...
function initShowdownPage(params) {
  ...
  `;
    div.appendChild(style);
    setTimeout(()=>{
        const result = (0, _state.state).whoWins(playerMove, computerMove);
        if (result === 'tie') params.goTo('/play');
        else params.goTo('/result');
    }, 2000);
    return div;
}

},{"../state/state":"gsPiT","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"fByw0":[function(require,module,exports,__globalThis) {
