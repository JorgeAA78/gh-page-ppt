const e={data:{currentGame:{playerPlay:"",computerPlay:""},history:{player:0,computer:0}},listeners:[],init(){},getState(){return this.data},setState(e){for(let t of(this.data=e,this.listeners))t();console.log("State updated:",this.data)},subscribe(e){this.listeners.push(e)},setPlayerMove(e){this.getState().currentGame.playerPlay=e,this.setComputerMove()},setComputerMove(){let e=["piedra","papel","tijera"][Math.floor(3*Math.random())],t=this.getState();t.currentGame.computerPlay=e,this.pushToHistory(t.currentGame.playerPlay,e)},whoWins:(e,t)=>e===t?"tie":"piedra"===e&&"tijera"===t||"papel"===e&&"piedra"===t||"tijera"===e&&"papel"===t?"win":"loss",pushToHistory(e,t){let n=this.getState(),a=this.whoWins(e,t);"win"===a&&n.history.player++,"loss"===a&&n.history.computer++,this.setState(n)},resetHistory(){let e=this.getState();e.history.player=0,e.history.computer=0,this.setState(e)}};var t={};t=import.meta.resolve("gyiAf");var n={};n=import.meta.resolve("bvizz");var a={};a=import.meta.resolve("ejkHH");const o=[{path:/\/welcome/,component:function(e){let t=document.createElement("div");t.innerHTML=`
  ...
  `,n.appendChild(i),setTimeout(()=>{"tie"===e.whoWins(o,r)?t.goTo("/play"):t.goTo("/result")},2e3),n}},{path:/\/result/,component:function(o){let r=document.createElement("div"),i=e.getState(),s=i.history.player>=3,l=i.history.computer>=3,c="",d="Siguiente Ronda",p=!1,h="";s?(c=t,d="Jugar de Nuevo",p=!0,h="¡Ganaste la partida!"):l?(c=n,d="Jugar de Nuevo",p=!0,h="Perdiste la partida"):"win"===e.whoWins(i.currentGame.playerPlay,i.currentGame.computerPlay)?(c=t,h="Ganaste esta ronda"):(c=n,h="Perdiste esta ronda"),r.innerHTML=`
    ${s&&p?`<img class="confetti" src="${a}" alt="confetti">`:""}
    <div class="result-container">
      <img class="result-image" src="${c}" alt="${h}">
      <div class="score-board">
        <h2 class="score-title">Score</h2>
        <p class="score-p">Vos: ${i.history.player}</p>
        <p class="score-p">M\xe1quina: ${i.history.computer}</p>
      </div>
      <button-el class="play-again-button">${d}</button-el>
    </div>
  ...
  `,r.appendChild(u);let m=r.querySelector(".play-again-button");return m&&m.addEventListener("click",()=>{p&&e.resetHistory(),o.goTo("/play")}),r},background:"solid"}];class r extends HTMLElement{constructor(){super(),this.render()}render(){let e=this.attachShadow({mode:"open"}),t=document.createElement("button"),n=document.createElement("style");t.textContent=this.textContent,n.innerHTML=`
      .button {
        width: 100%;
        height: 87px;
    ...
    `,t.classList.add("button"),e.appendChild(n),e.appendChild(t)}}customElements.define("button-el",r);var i={};i=import.meta.resolve("9dVwf");var s={};s=import.meta.resolve("6kYrV");var l={};l=import.meta.resolve("6FgcY");class c extends HTMLElement{constructor(){super(),this.shadow=this.attachShadow({mode:"open"}),this.type=this.getAttribute("type")||"piedra",this.render()}render(){let e,t=document.createElement("style");"piedra"===this.type&&(e=i),"papel"===this.type&&(e=s),"tijera"===this.type&&(e=l),t.innerHTML=`
      .hand {
    ...
    `,this.shadow.innerHTML='<div class="hand"></div>',this.shadow.appendChild(t)}}customElements.define("hand-el",c);const d=document.querySelector("#root");d&&(e.init(),function(t){let n="/gh-page-ppt";function a(){return location.host.includes("github.io")}function r(e){let t=a()?`${n}${e}`:e;history.pushState({},"",t),i(e)}function i(n){for(let a of(console.log(`Navigating to: ${n}`),o))if(a.path.test(n)){let n=a.component({goTo:r});if(t.style.backgroundImage="",t.style.backgroundColor="transparent","solid"===a.background){let n=e.whoWins(e.getState().currentGame.playerPlay,e.getState().currentGame.computerPlay);"win"===n&&(t.style.backgroundColor="#888949"),"loss"===n&&(t.style.backgroundColor="#894949")}t.firstChild&&t.firstChild.remove(),t.appendChild(n);return}r("/welcome")}function s(e){return a()&&e.startsWith(n)?e.substring(n.length)||"/":e}i(s(location.pathname)),window.onpopstate=()=>{i(s(location.pathname))}}(d));
//# sourceMappingURL=PPT.ccfc03dd.js.map
