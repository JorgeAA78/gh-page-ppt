const e={data:{currentGame:{playerPlay:"",computerPlay:""},history:{player:0,computer:0}},listeners:[],init(){let e=localStorage.getItem("saved-state");e&&(this.data.history=JSON.parse(e))},getState(){return this.data},setState(e){for(let t of(this.data=e,this.listeners))t();localStorage.setItem("saved-state",JSON.stringify(this.data.history)),console.log("State updated:",this.data)},subscribe(e){this.listeners.push(e)},setPlayerMove(e){this.getState().currentGame.playerPlay=e,this.setComputerMove()},setComputerMove(){let e=["piedra","papel","tijera"][Math.floor(3*Math.random())],t=this.getState();t.currentGame.computerPlay=e,this.pushToHistory(t.currentGame.playerPlay,e)},whoWins:(e,t)=>e===t?"tie":"piedra"===e&&"tijera"===t||"papel"===e&&"piedra"===t||"tijera"===e&&"papel"===t?"win":"loss",pushToHistory(e,t){let n=this.getState(),a=this.whoWins(e,t);"win"===a&&n.history.player++,"loss"===a&&n.history.computer++,this.setState(n)}};var t={};t=import.meta.resolve("gyiAf");var n={};n=import.meta.resolve("bvizz");var a={};a=import.meta.resolve("4Qf34");var o={};o=import.meta.resolve("4wmXX");const r=[{path:/\/welcome/,component:function(e){let t=document.createElement("div");t.innerHTML=`
  ...
  `,t.appendChild(n);let a=t.querySelector(".play-button");return a&&a.addEventListener("click",()=>{e.goTo("/play")}),t},background:`url(${o})`},{path:/\/play/,component:function(t){let n=document.createElement("div"),a=3,o=()=>{let o=n.querySelector(".countdown-number");o&&(o.textContent=String(a)),--a<0&&(clearInterval(r),""===e.getState().currentGame.playerPlay?t.goTo("/instructions"):t.goTo("/showdown"))},r=setInterval(o,1e3);n.innerHTML=`
  ...
  `,n.appendChild(i);let s=n.querySelectorAll(".hand");return s.forEach(t=>{t.addEventListener("click",()=>{let n=t.getAttribute("type");e.setPlayerMove(n),s.forEach(e=>e.classList.remove("selected")),t.classList.add("selected")})}),o(),n},background:`url(${o})`},{path:/\/showdown/,component:function(t){let n=document.createElement("div"),a=e.getState(),o=a.currentGame.playerPlay,r=a.currentGame.computerPlay;n.innerHTML=`
  ...
  `,n.appendChild(i),setTimeout(()=>{t.goTo("/result")},3e3),n},background:`url(${o})`},{path:/\/result/,component:function(o){let r=document.createElement("div"),i=e.getState(),s=e.whoWins(i.currentGame.playerPlay,i.currentGame.computerPlay),l="";"win"===s&&(l=t),"loss"===s&&(l=n),"tie"===s&&(l=a),r.innerHTML=`
    <div class="result-container">
      <img class="result-image" src="${l}" alt="Resultado: ${s}">
  ...
  `,r.appendChild(c);let d=r.querySelector(".play-again-button");return d&&d.addEventListener("click",()=>{o.goTo("/instructions")}),r},background:"solid"}];class i extends HTMLElement{constructor(){super(),this.render()}render(){let e=this.attachShadow({mode:"open"}),t=document.createElement("button"),n=document.createElement("style");t.textContent=this.textContent,n.innerHTML=`
      .button {
        width: 100%;
        height: 87px;
    ...
    `,this.shadow.innerHTML='<div class="hand"></div>',this.shadow.appendChild(t)}}customElements.define("hand-el",d);const p=document.querySelector("#root");if(p){e.init();function h(e){history.pushState({},"",e),u(e)}function u(t){for(let n of(console.log(`Navigating to: ${t}`),r))if(n.path.test(t)){let t=n.component({goTo:h});if("solid"===n.background){let t=e.whoWins(e.getState().currentGame.playerPlay,e.getState().currentGame.computerPlay);"win"===t&&(p.style.backgroundColor="#888949"),"loss"===t&&(p.style.backgroundColor="#894949"),"tie"===t&&(p.style.backgroundColor="#D5D588"),p.style.backgroundImage="none"}else p.style.backgroundImage=n.background,p.style.backgroundColor="transparent";p.firstChild&&p.firstChild.remove(),p.appendChild(t)}}"/"===location.pathname?(history.replaceState({},"","/welcome"),u("/welcome")):u(location.pathname),window.onpopstate=()=>{u(location.pathname)}}
//# sourceMappingURL=PPT.ed208ae0.js.map
